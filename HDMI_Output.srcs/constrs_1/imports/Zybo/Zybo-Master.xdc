...
#set_property -dict { PACKAGE_PIN V16 assign logic_reset = ~pll_locked;VCMOS33 } [get_ports { btn[2] }]; #IO_L18P_T2_34 Sch=BTN2
...
set_property -dict { PACKAGE_PIN C20   IOSTANDARD TMDS_33 } [get_ports { hdmi_d_p[1] }]; #IO_L1P_T0_35 Sch=HDMI_D1_P
